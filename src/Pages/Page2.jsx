...
const Page2 = () => {
    ...
    <div id="section2" className="bg-white text-center text-black p-20">
      <h3 className="text-gray-500 text-xl font-[anzo3]">
        © mayank.studio 2024 | designed and developed
      </h3>
      <div className="rotatetext" 
      >
        <h1 className="text-[42vw] text-black font-[anzo4]  leading-[35vw]  "
        style={{
    ...
    <g>
      ...
      <div className="h-1 w-1/3 bg-black relative left-1/2 -translate-x-1/2 mt-8 ">
